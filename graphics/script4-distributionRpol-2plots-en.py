...
axs[0].set_xlabel(r'Variance ($\sigma^2$) of ratings by item')
...
sns.kdeplot(polarizacoes_goodbooks_alfa08_Xest, color='red', linestyle='-', 
            label=fr'$\mathcal{{R}}_{{pol}}$ (before) = {media_goodbooks_alfa08_Xest:.2f}', 
            ax=axs[1], fill=True, alpha=0.05, zorder=1)

sns.kdeplot(polarizacoes_goodbooks_alfa08_Xpi, color='green', linestyle='-', 
            label=fr'$\mathcal{{R}}_{{pol}}$ (after) = {media_goodbooks_alfa08_Xpi:.2f}', 
            ax=axs[1], fill=True, alpha=0.05, zorder=1)
...
axs[1].set_xlabel(r'Variance ($\sigma^2$) of ratings by item')

...
fig.suptitle('Comparative Density Plot')

# Subplot para MovieLens com α=0.2
sns.kdeplot(valores_movielens_alfa02_X_continuos, color='blue', linestyle='-', label='Known Ratings', ax=axs[0, 0], fill=True, alpha=0.05)
sns.kdeplot(valores_movielens_alfa02_Xest, color='red', linestyle='-', label='Estimated Ratings (before)', ax=axs[0, 0], fill=True, alpha=0.05)
sns.kdeplot(valores_movielens_alfa02_Xpi, color='green', linestyle='--', label='Estimated Ratings (after)', ax=axs[0, 0], fill=True, alpha=0.05)
...
sns.kdeplot(valores_movielens_alfa08_X_continuos, color='blue', linestyle='-', label='Known Ratings', ax=axs[0, 1], fill=True, alpha=0.05)
sns.kdeplot(valores_movielens_alfa08_Xest, color='red', linestyle='-', label='Estimated Ratings (before)', ax=axs[0, 1], fill=True, alpha=0.05)
sns.kdeplot(valores_movielens_alfa08_Xpi, color='green', linestyle='--', label='Estimated Ratings (after)', ax=axs[0, 1], fill=True, alpha=0.05)
...
sns.kdeplot(valores_goodbooks_alfa02_X_continuos, color='blue', linestyle='-', label='Known Ratings', ax=axs[1, 0], fill=True, alpha=0.05)
sns.kdeplot(valores_goodbooks_alfa02_Xest, color='red', linestyle='-', label='Estimated Ratings (before)', ax=axs[1, 0], fill=True, alpha=0.05)
sns.kdeplot(valores_goodbooks_alfa02_Xpi, color='green', linestyle='--', label='Estimated Ratings (after)', ax=axs[1, 0], fill=True, alpha=0.05)
...
sns.kdeplot(valores_goodbooks_alfa08_X_continuos, color='blue', linestyle='-', label='Known Ratings', ax=axs[1, 1], fill=True, alpha=0.05)
sns.kdeplot(valores_goodbooks_alfa08_Xest, color='red', linestyle='-', label='Estimated Ratings (before)', ax=axs[1, 1], fill=True, alpha=0.05)
sns.kdeplot(valores_goodbooks_alfa08_Xpi, color='green', linestyle='--', label='Estimated Ratings (after)', ax=axs[1, 1], fill=True, alpha=0.05)
